...
draw = function(canvas_name) {
  ...
  if (typeof Worker !== "undefined") {
    ...
    for (i = _i = 0; 0 <= num_workers ? _i < num_workers : _i > num_workers; i = 0 <= num_workers ? ++_i : --_i) {
      ...
      $("#load_info").append('<div class="progress progress-striped active"> <div class="progress-bar ' + js_class + '" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="height: 0%"> </div> </div>');
    }
